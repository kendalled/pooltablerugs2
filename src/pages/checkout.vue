<template>
  ...
  <div class="flex flex-col max-w-6xl mx-auto py-12 lg:flex-row h-screen w-screen">
    ...
    <section id="content" class="w-7/12 shadow-md rounded-r px-8 py-16">
      ...
      <div v-for="i in 3" :key="i" class="w-full my-6 items-center justify-between flex h-auto bg-white rounded shadow-md py-6 pl-6 px-6">
        <div class="w-1/8">
        ...
        <div class="w-1/4 h-full flex flex-col">
          <div class="w-full h-full text-center">
            <Counter label-text="Qty" :val="i" @increment="handleChange" @decrement="handleChange" />
          </div>
        </div>
