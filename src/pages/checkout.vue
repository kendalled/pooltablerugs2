<template>
  ...
  <div class="flex flex-col px-48 py-12 lg:flex-row h-screen w-screen">
    <!-- copy these classes -->
    <form class="w-full h-full pt-16 pb-10 px-16 bg-white rounded-l shadow-md">
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
        <div class="w-full px-3">
          ...
          <input id="grid-password" autocomplete="new-password" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="password" placeholder="******************">
      ...
      <div class="flex flex-wrap flex-row justify-between border-t pt-6 mt-6 -mx-3">
        <Checkbox class="checky" />
        <div class="controls">
          <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="#">
            Need Help?
          </a>
          <button class="ml-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
            Continue
          </button>
        </div>
      </div>
    </form>
    <section class="bg-green-600 w-7/12 shadow-md rounded-r px-8 py-16">
      <h1
      ...
      <div class="h-1 mx-auto bg-gray-100 w-48 opacity-75 mb-4 mt-4 rounded" />
      <div v-for="i in 3" :key="i" class="w-full my-6 items-start justify-between flex h-auto bg-white rounded shadow-md py-4 pl-6 px-6">
        <div class="w-1/4">
        ...
        <div class="flex w-1/4 mt-1 h-full items-end flex-row">
