<template>
  ...
  <div class="mx-auto px-6 pt-12 pb-6 lg:pb-48 lg:px-48 bg-white">
    <h1
      class="text-center text-3xl text-gray-700 font-medium leading-snug"
    >
      Protect your game room with a rug.
    </h1>
    <p class="text-center text-lg text-gray-700 mt-2 px-6">
      From spills to scuffs, a high quality rug will keep your game room tidy.
    </p>
    <div class="h-1 mx-auto bg-green-600 w-24 opacity-75 my-8 rounded" />
    <!-- Carousel Body -->
    <div class="relative rounded-lg block md:flex items-center bg-white shadow-xl" style="min-height: 19rem;">
    ...
    <div class="flex items-center pt-5 justify-between">
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100">
        <img class="w-full" src="https://stripe.com/img/v3/payments/overview/logos/kickstarter.svg" alt="" style="max-height: 60px;">
      </button>
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100">
        <img class="w-full" src="https://stripe.com/img/v3/payments/overview/logos/slack.svg" alt="" style="max-height: 60px;">
      </button>
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100">
        <img class="w-full" src="https://stripe.com/img/v3/payments/overview/logos/glossier.svg" alt="" style="max-height: 60px;">
      </button>
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100">
        <img class="w-full" src="https://stripe.com/img/v3/payments/overview/logos/charity_water.svg" alt="" style="max-height: 60px;">
      </button>
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100">
        <img class="w-full" src="https://stripe.com/img/v3/payments/overview/logos/missguided.svg" alt="" style="max-height: 60px;">
      </button>
    </div>
  </div>
