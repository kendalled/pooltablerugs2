<template>
  <div class="px-16 pt-4 pb-12 bg-gray-800">
    <h1 class="text-3xl mt-12 text-green-400 font-bold text-center px-10">
      Get started with the facts.
    </h1>

    <h2 class="text-lg mb-8 mt-2 px-10 text-center text-gray-100">
      From rug use-cases to support info, read about our services below.
    </h2>

    <ul class="flex flex-wrap">
      <li class="w-full sm:w-1/2 flex flex-col">
        <div class="flex flex-col h-full bg-gray-100 rounded shadow m-6 py-6 px-8">
          <h2 class="text-2xl mb-4 text-gray-900 font-semibold">
            Rugs are a necessity for any game room.
          </h2>
      ...
      <li class="w-full sm:w-1/2 flex flex-col">
        <div class="flex flex-col h-full bg-gray-100 rounded shadow m-6 py-6 px-8">
          <h2 class="text-2xl mb-4 text-gray-900 font-semibold">
            Rugs help reduce noise drastically.
          </h2>
          <p class="flex-grow text-gray-800">
