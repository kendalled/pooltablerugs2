<template>
  <div class="flex items-center justify-center">
    <div class="mt-6">
      <button @click="open = true" class="ml-8 mb-64 px-3 py-2 font-medium text-center text-sm rounded-lg bg-gray-300 text-gray-900 hover:bg-gray-400 focus:outline-none transition-bg">
        Sign In
      </button>
