    ...
    <div class="lg:px-8">
      ...
      >
        ...
        <div class="flex-shrink-0 pr-4 lg:hidden">
          <LoginModal @log-in="signIn" @log-out="signOut" class="inline-block" />
          <button
            ref="openButton"
            @click="open"
            type="button"
            class="inline-block text-gray-600 focus:outline-none focus:text-gray-900"
            aria-label="Menu"
          >
            <svg class="h-6 w-6 -mb-2" fill="currentColor" viewBox="0 0 24 24">
              <path
